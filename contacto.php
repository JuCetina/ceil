...
if(isset($_POST)){
    ...
    if(isset($_POST['nombre']) && isset($_POST['apellido']) && isset($_POST['email']) && isset($_POST['tel']) && isset($_POST['mensaje']))
    {
        ...
        $mensaje = "<strong>DATOS DE CONTACTO:</strong> <br/><br/><strong>Nombre:</strong> $nombre $apellido <br/><strong>Email:</strong> $email <br/><strong>Teléfono o Celular:</strong> $tel <br/>".htmlspecialchars(trim($_POST['mensaje']));
